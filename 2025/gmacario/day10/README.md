...
The button wiring schematics are still relevant: in this new joltage configuration mode, each button now indicates which counters it affects, where `0` means the first counter, `1` means the second counter, and so on. When you push a button, each listed counter is _increased by 1_.
...
Although it hasn't changed, you can still [get your puzzle input](https://adventofcode.com/2025/day/10/input).
