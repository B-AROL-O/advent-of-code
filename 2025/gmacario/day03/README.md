...
- In _`9`_`87654321111111`, you can make the largest joltage possible, _`98`_, by turning on the first two batteries.
...
- In _`987654321111`_`111`, the largest joltage can be found by turning on everything except some 1s at the end to produce _`987654321111`_.
- In the digit sequence _`81111111111`_`111`_`9`_, the largest joltage can be found by turning on everything except some 1s, producing _`811111111119`_.
...
- In _`8`_`1`_`8`_`1`_`8`_`1`_`911112111`_, the joltage _`888911112111`_ is produced by turning on everything except some 1s near the front.
