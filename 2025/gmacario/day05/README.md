...
The Elves are trying to determine which of the _available ingredient IDs_ are fresh. In this example, this is done as follows:
...
Process the database file from the new inventory management system. _How many of the available ingredient IDs are fresh_?
